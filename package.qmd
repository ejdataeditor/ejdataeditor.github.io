...
For folders 1 and 2, please refer to the Economic Journal's [General Instructions to Authors](https://academic.oup.com/ej/pages/General_Instructions) and [Guide for Accepted Authors](/Guide-for-Accepted-Authors-21-12-2025.pdf) and carefully follow the instructions indicated there. In the lines below, you will find specific guidelines about folder 3 and, if you were granted a data exemption at the time of first submission (see [here](before.qmd#apply-to-exemptions-to-the-data-and-code-availability-policy), [here](faqs.qmd#data-and-code-availability-policy-and-exemptions), and [here](faqs.qmd#procedures-when-exemptions-are-granted) for details), also folder 4.


::: {.callout-important}
# Sign and Submit Checklist ☑
Along with your package, you are requested to download, fill, sign and submit [this checklist](checklist.pdf), which refers to the contents of the package below
:::
...
1. Upload the `zip` compressed version of your replication package along with your `README.pdf` file (i.e. the **exact same** versions of `3-replication-package.zip` and `README.pdf` which you sent us in your final iteration of the replication package). Drag-and-drop the zip file and pdf to upload them, as shown below. Make sure you only publish the replication package and _not_ the paper or online appendices. Especially, **do not publish the content of the `4-confidential-data-not-for-publication.zip` folder**! 
