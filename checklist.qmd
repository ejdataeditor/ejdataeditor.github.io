...
- [ ] I have checked that my reference list meets the style requirements of the journal and that my references are complete, particularly in the use of capitals, the inclusion of issue and page numbers, and including full author names.
...
I confirm that this README contains:
...
### 2.5. Folder `4-confidential-data-not-for-publication.zip` (if applicable)
...
### 2.6. Personally Identifiable Information (if applicable)

- [ ] I confirm that all datasets shared with my replication materials contain no personally identifiable information (PII) on research subjects for which I do not have explicit approval to share, and that all data sharing complies with relevant privacy regulations and consent agreements.
